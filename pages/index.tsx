  ...
  return (
    <div className="flex flex-col">
      ...
      >
        ...
        <a
          href="#portfolio"
          className="px-6 py-3 font-bold rounded-full hover:bg-blue-600 transition"
          style={{
      ...
      {/* Contact Section */}
      <section
        className="p-8 sm:p-20 rounded-xl"
        style={{
          backgroundColor: "var(--contact-bg)",
          color: "var(--contact-text)",
        }}
      >
        ...
        <p className="text-lg mb-4">
          <a
            href="mailto:andreaskdahlgren@gmail.com"
