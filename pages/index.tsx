...
const Home = ({}: HomeProps) => {
  ...
  return (
    <div className="flex flex-col">
      {/* Hero Section */}
      <section className="flex flex-col items-center justify-center min-h-screen" style={{ backgroundColor: 'var(--hero-bg)', color: 'var(--hero-text)' }}>
      ...
      {/* Portfolio Section */}
      <section id="portfolio" className="p-8 sm:p-20" style={{ backgroundColor: 'var(--portfolio-bg)', color: 'var(--portfolio-text)' }}>
