...
export function activate(context: vscode.ExtensionContext) {
    ...
    context.subscriptions.push(vscode.commands.registerCommand('my-test-extension.helloWorld', () => {
    ...
    context.subscriptions.push(vscode.commands.registerCommand('my-test-extension.showCurrentConnection', () => {
        // The code you place here will be executed every time your command is executed
